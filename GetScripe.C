...
const string BashFile = "FileList250922.sh";
const string OutputPath = "./TBBO_PWO250922/";
...
const string VDirs[NumDirs]={
  ...
  "/data8/ZDC/EMCal/CitiROC_Cosmic_Data/2025-09-23/Run4001*0330*"
...
const string VSDirs[NumDirs]={
  "/data8/ZDC/EMCal/BothZDCABM/AnaCode1/TBBO_PWO250922/Run4k_0330/"
};
